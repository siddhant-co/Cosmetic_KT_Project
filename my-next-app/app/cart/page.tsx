...
// Dummy cart data - replace with API or DB data if needed
const cartItems = [
  {
    id: 1,
    title: "Skin Glow Kit",
    ...
    price: 11,
    quantity: 1,
    image: "/sample-product.jpg", // Store this in /public or make it dynamic
  },
];
            ...
            >
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <button className="flex items-center text-red-600 mt-2 text-xs hover:underline">
